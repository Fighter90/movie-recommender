...
function populateMoviesDropdown() {
    ...
    // Add the same movie options to the profile selectors
    ['watched-1', 'watched-2', 'watched-3'].forEach(selectId => {
        ...
        setTimeout(() => {
            try {
                ...
                const scoredMovies = candidateMovies.map(candidate => {
                    ...
                    const score = denominator > 0 ? intersection.size / denominator : 0;
